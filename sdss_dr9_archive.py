# Archive class specialization for SDSS DR9 imaging queries
# 
# This module defines a new class (SloanDR9Archive) derived from the 
...
DEC_LABEL = None
RADEC_LABEL = "radecs"
ARCHIVE_NAME = "Sloan Digital Sky Survey (DR9) Science Archive Server -- Coverage Check"
ARCHIVE_SHORTNAME = "sdss-dr9"
...
# requirements 
class SloanDR9Archive(basic_archive.BasicArchive):
	...
	def AnalyzeHTML(self, htmlText):
		...
		if ( connectionMade ):
			if ( validReply ):
				if ( nDataFound > 0 ):
					messageString = "DR9 imaging data exists!"
...
def MakeArchive():
	return SloanDR9Archive(ARCHIVE_NAME, ARCHIVE_SHORTNAME, ARCHIVE_URL,
